---
description: Copy the reusable convention rule files (Makefile, .env, comments) into this project's .claude/rules/ so they auto-load on matching files.
argument-hint: [makefile|env-files|comments|all]
---
